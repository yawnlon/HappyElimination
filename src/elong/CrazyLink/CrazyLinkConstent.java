...
public class CrazyLinkConstent {
	...
	public enum E_SOUND {
		SLIDE, FILL, DISAPPEAR3, DISAPPEAR4, DISAPPEAR5, DISAPPEARNO, READYGO, TIMEOVER, LEVELUP, SUPER, COOL, GOOD, PERFECT, BOMB, MONSTER, LIFEADD, LIFEDEL, BREAK_FIRE, BREAK_ICE
	}

	public enum E_TIP {
		READYGO, LEVELUP, GAMEOVER,
	}
