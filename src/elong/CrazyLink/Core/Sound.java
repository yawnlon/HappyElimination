...
public class Sound {
	...
	private void initSounds() {
		...
		loadSfx(R.raw.s_disappearno, E_SOUND.DISAPPEARNO.ordinal());
		...
		loadSfx(R.raw.s_break_fire, E_SOUND.BREAK_FIRE.ordinal());
		loadSfx(R.raw.s_break_ice, E_SOUND.BREAK_ICE.ordinal());
	}
